...
func (a *ChartRepositoryApiService) ChartrepoChartsPost(ctx context.Context, chart *os.File, localVarOptionals *ChartrepoChartsPostOpts) (*http.Response, error) {
	var (
...
*/
func (a *ChartRepositoryApiService) ChartrepoHealthGet(ctx context.Context) (InlineResponse2001, *http.Response, error) {
	var (
...
*/
func (a *ChartRepositoryApiService) ChartrepoRepoChartsNameVersionGet(ctx context.Context, repo string, name string, version string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *ChartRepositoryApiService) ChartrepoRepoChartsPost(ctx context.Context, repo string, chart *os.File, localVarOptionals *ChartrepoRepoChartsPostOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
